...
func MigrateAndSeed(db interface{}) {
	...
	seederSQL := `
	INSERT INTO subscription.packages (id, name, price, duration, quota, status, created_at)
	VALUES 
	    ('a1b2c3d4-e5f6-7890-1234-567890abcdef', 'Paket Basic', 150000.00, 1, 100, 'ACTIVE', CURRENT_TIMESTAMP),
	    ('b2c3d4e5-f678-9012-3456-7890abcdef12', 'Paket Pro', 500000.00, 6, 1000, 'ACTIVE', CURRENT_TIMESTAMP),
	    ('c3d4e5f6-7890-1234-5678-90abcdef1234', 'Paket Enterprise', 1200000.00, 12, 5000, 'ACTIVE', CURRENT_TIMESTAMP),
	    ('d4e5f6a7-8901-2345-6789-0abcdef12345', 'Paket Starter', 49000.00, 1, 50, 'INACTIVE', CURRENT_TIMESTAMP),
	    ('e5f6a7b8-9012-3456-7890-abcdef123456', 'Paket Trial', 0.00, 1, 10, 'INACTIVE', CURRENT_TIMESTAMP)
